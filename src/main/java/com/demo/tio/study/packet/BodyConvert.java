...
import com.demo.tio.study.utils.ByteUtil;
import com.demo.tio.study.utils.ContextUser;
import com.demo.tio.study.utils.LayimConst;
...
public class BodyConvert {
    ...
    public LayimToClientChatMsgBody convertToClientMsgBody(ChatRequestBody requestBody, ChannelContext channelContext){
        ...
        //先获取用户信息
        ContextUser contextUser =(ContextUser)channelContext.getAttribute(channelContext.userid);
        //设置当前用户名
        ...
        if(requestBody.getMtype()==LayimMsgType.CLIENT_TO_CLIENT){
            ...
            msgBody.setToid(requestBody.getToId());
            //消息类型：好友
            ...
            msgBody.setFrom(channelContext.userid);
        }
